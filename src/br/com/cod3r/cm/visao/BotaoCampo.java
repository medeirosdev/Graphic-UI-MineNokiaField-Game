...
public class BotaoCampo extends JButton 
	...
	private final Color BG_PADRAO = new Color(186, 193, 184);
	private final Color BG_MARCAR = new Color(113, 169, 247);
	private final Color BG_EXPLODIR = new Color(214, 73, 51);
	private final Color TEXTO_VERDE = new Color(12, 124, 89);
